...
public class ProfilesOfUsers extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_profiles_of_users);
...
//        the userID got from Usersactivity
        ...
        mSelectedUser = FirebaseDatabase.getInstance().getReference().child("users").child(userid); /*use to read/ write data to realtime database for USERs group*/
        ...
        mFriendRequestDatabase.child(mCurrentUser.getUid()).child(userid).addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                try{
                    ...
                    mFriendListDatabase.child(mCurrentUser.getUid()).child(userid).addValueEventListener(new ValueEventListener() {
                        @Override
        ...
        mSelectedUser.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                status.setText("Intrested in: "+user_status);
                if (!user_avatar.equals("default")) {
                    Picasso.get().load(user_avatar).placeholder(R.drawable.profile).into(userAvatar);
                        ...
                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(Task<Void> task) {
                                if (task.isSuccessful()) {
                                    ...
                                    mFriendRequestDatabase.child(userid).child(mCurrentUser.getUid()).child("request_type").setValue("received");
                                    Toast.makeText(ProfilesOfUsers.this, "Sent request successfully", Toast.LENGTH_SHORT).show();
                                }
                            }
                        });
        ...
        btnCancelRequest.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mFriendRequestDatabase.child(mCurrentUser.getUid()).child(userid).removeValue();
                /*delete the received_request data for receiver*/
                mFriendRequestDatabase.child(userid).child(mCurrentUser.getUid()).removeValue();
            }
        });
        ...
        btnAcceptRequest.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mFriendListDatabase.child(userid).child(mCurrentUser.getUid()).child("from").setValue(timeStamp);
                /*Insert selected_userid to list friend of mCurrentUser*/
                mFriendListDatabase.child(mCurrentUser.getUid()).child(userid).child("from").setValue(timeStamp);
            }
        });
        ...
        btnUnfriend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mFriendListDatabase.child(mCurrentUser.getUid()).child(userid).removeValue();
                /*delete current user in friend list of selected user*/
                mFriendListDatabase.child(userid).child(mCurrentUser.getUid()).removeValue();
            }
        });
